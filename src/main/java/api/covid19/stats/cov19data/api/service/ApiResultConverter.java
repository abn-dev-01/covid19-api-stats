...
@Service
/**
 * Converted COVID19 API Results to SYSTEM Statistics DTO.
 */
public class ApiResultConverter {

    /**
     * Converter {@link api.covid19.stats.cov19data.api.dto.TotalCountry} to {@link api.covid19.stats.cov19data.api.dto.StatisticsCountriesAndPeriod}
     *
     * @param apiResult
     *
     * @return
     */
    public StatisticsCountriesAndPeriod fromTotalCountryRs(TotalCountry apiResult) {
